// Rocket rocket; // global rocket object
...
void loop() {
  ...
  //readSensors();  // Read IMU/GPS, sensor array
  ...
  rocket.lastLogTime = logger.update(SensorReport, rocket); // writes flight data to flash memory, then at end writes to mircoSD
